 ...
 * @author adity
 */
public class CreatePrescriptionRequest extends javax.swing.JPanel {
    ...
    /**
     * Creates new form PrescribeChildrenJPanel
     */

    CreatePrescriptionRequest(JPanel userProcessContainer, HealthEventWorkRequest request, Organization organization, Employee child, EcoSystem ecosystem, UserAccount account) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(backButton);
        backButton.setBounds(220, 10, 120, 40);
        ...
        add(submitButton);
        submitButton.setBounds(1140, 540, 130, 40);

        ngoNameTextField.setEditable(false);
        add(ngoNameTextField);
        ngoNameTextField.setBounds(1230, 210, 222, 30);

        checkupTextField.setEditable(false);
        add(checkupTextField);
        checkupTextField.setBounds(1230, 260, 222, 30);
        add(ageTextField);
        ageTextField.setBounds(1230, 360, 222, 30);
        add(prescriptionTextField);
        prescriptionTextField.setBounds(1230, 410, 222, 30);
        add(childNameTextField);
        childNameTextField.setBounds(1230, 310, 222, 30);
        add(dateTextField);
        dateTextField.setBounds(1230, 460, 250, 30);
    ...
    private void disableRadio() {
        ...
        prescriptionTextField.setEnabled(false);
    }


    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        if (childNameTextField.getText().equals("") || dateTextField.getText().equals("") || prescriptionTextField.getText().equals("") || ageTextField.getText().equals("")) {
        ...
        if (!prescriptionTextField.getText().matches("[A-Za-z0-9]+$")) {
            JOptionPane.showMessageDialog(null, "Please enter comments (a-z)/(1-9) !");
            return;
        }
        ...
        try {
            ...
            presReq.setDetails(prescriptionTextField.getText());
